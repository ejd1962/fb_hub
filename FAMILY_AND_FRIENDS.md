# FAMILY_AND_FRIENDS.md
# Eric's Family and Friends - Context for Claude Code
========================================================================
...
- **Role during Eric's 6-month trip:** Storing Ford Escape (confirmed YES Nov 1, 2025)
- **Sons' relationship:** Mother of Andrew, James, and William
- **Sunday Nov 2, 2025:** Hosted Sunday dinner for Andrew and James
...
- **Knows:** Ford storage location at Cheryl's, key under driver's floor mat, anti-theft starting trick (push key INTO steering column)
...
- **Nov 2, 2025:** Visited mom (Cheryl) for Sunday dinner, Eric decided not to see sons before trip (no time)
...
- **Current:** 2 more months of workterm in Toronto (as of Nov 2025)
- **Location:** Toronto
...
- **Relationship:** Friend, has on-again off-again boyfriend named Michael
- **Role during Eric's trip:** Hosting Furnace Server (Laptop B) in basement furnace room for 6 months
- **Nov 2, 2025:** Had date with Michael Sunday afternoon
...
**This document provides context for Claude Code when Eric mentions family members, friends, or key contacts. For property/cottage info, see OTTER_LAKE_COTTAGE_COMPOUND_INFO.md. For personal health info, see PERSONAL_INFO.md.**
